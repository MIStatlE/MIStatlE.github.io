...
| 阶段 | 学什么 | 推荐资源 |
|------|--------|----------|
| **基础入门** | 生成模型动机、得分函数 | [Ho et al. (2020)](https://arxiv.org/abs/2006.11239), [DeepMind Diffusion Lectures](https://deepmind.com/learning-resources) |
| **数学基础** | 随机过程与 SDE | 《Stochastic Differential Equations》 by Øksendal, [MIT 18.675](https://ocw.mit.edu) |
| **确定性流** | DDIM 与 Flow Matching | [DDIM Paper](https://arxiv.org/abs/2010.02502), [Flow Matching (Lipman, 2023)](https://arxiv.org/abs/2210.02747) |
...
### 📗 Books
- [《Pattern Recognition and Machine Learning》](https://www.springer.com/gp/book/9780387310732) — Bishop, ch.12 生成模型
- [《Stochastic Processes and Applications》](https://www.cambridge.org/core/books/abs/stochastic-processes-and-applications) — Gardiner
- [《High-Dimensional Probability》](https://www.cambridge.org/core/books/highdimensional-probability/43D9A8A3A9E5C2B9A91AF5D69368D94B) — Roman Vershynin
...
- [DeepMind x UCL Diffusion Seminar (YouTube Playlist)](https://www.youtube.com/playlist?list=PLqYmG7hTraZCkftCvihsG2zQ_N9l3QOjo)

### 💻 Code & Demos
- [DDPM Official Implementation](https://github.com/hojonathanho/diffusion)
...
- [MIStatlE Diffusion Notes (本站内部链接)](../notes/)
### 🔗 Next Steps
- [📘 Gaussian Diffusion 基础](./gaussian-basics.qmd)
- [🧩 DDPM 推导与实现](./ddpm.qmd)
- [⚙️ DDIM & ODE 视角](./ddim.qmd)
- [🌊 Flow Matching 实战](./flow-matching.qmd)
- [📚 理论延伸与阅读](./theory.qmd)
- [📗 外部课程与书籍资源](#resources)
::: {.callout-tip title="📘 推荐资料（点击展开）" collapse="true"}
- [Deep Generative Models — Stanford CS236](https://deepgenerativemodels.github.io)
- [Flow Matching (Lipman et al. 2023)](https://arxiv.org/abs/2210.02747)
- [MIT 18.675: Stochastic Processes](https://ocw.mit.edu)
:::
